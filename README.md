...
<p>I'm lazy and want to search the same thing on multiple sites</p>
...
### Note
This an Android port of my other project [Multisearch](https://github.com/Noahffiliation/Multisearch), which is a Chrome extension that does the same thing.
